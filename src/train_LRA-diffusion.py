...
if __name__ == "__main__":
    ...
    parser.add_argument("--ddim_n_step", default=10, help="ddim_n_step", type=int)
    ...
    diffusion_model = Diffusion(fp_encoder=fp_encoder, n_class=n_class, fp_dim=fp_dim, feature_dim=2048,
    ...
    train(diffusion_model, train_dataset, val_dataset, test_dataset, model_path, n_epochs=args.nepoch,
          batch_size=args.batch_size, k=args.k, real_fp=real_fp, warmup_epochs=10)
